<template>
  <div class="container">
    <h1 class="container_name">AirPods</h1>
    ...
    <div v-if="showFilters" class="filter">
      ...
      <input class="before-input" type="text" placeholder="От" v-model="filter_price_before">
      <input class="after-input" type="text" placeholder="До" v-model="filter_price_after">
...
<script>
import {DATA_BASE_AIRPODS} from "@/assets/js/data_base";
